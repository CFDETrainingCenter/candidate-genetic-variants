...
We will send 25 gene identifiers from the heart-failure paper to biological
...
GTEx, HuBMAP, and Pharos contain different biological data. We will use each API
to ask a different question about the same 25 genes.
...
predictions for one missense VUS. ProtVar is not a CFDE resource. It provides
variant-level predictions that complement the gene and protein data.
