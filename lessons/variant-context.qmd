...
46 people and 25 genes. The authors reported these variants as pathogenic,
likely pathogenic, or VUS with suggestive evidence.

We retain the reported study score and class. GTEx, HuBMAP, and Pharos then
provide additional information about the genes.

::: {.callout-tip title="Why add biological context?"}
...
This comparison shows where the candidate genetic variant rows are concentrated
while keeping the classifications reported by the source study.
