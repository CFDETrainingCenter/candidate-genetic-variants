...
HuBMAP extends the paper's variant analysis with cell-type information. We
...
The plot shows the 10 highest means from the complete 14-gene table. The full
table retains all 14 genes.

The availability summary retains the 11 unavailable genes.
