...
: A table operation in which several variant rows can match one gene row. Used
  ...
  attaching shared gene-level data where appropriate. [Learn more about
  validating joins in
...
: A variant for which the available evidence is insufficient or conflicting for
  ...
  priorities, but it cannot establish whether a VUS is pathogenic or benign by
  itself. [Learn more about the ACMG/AMP
  standards.](https://pubmed.ncbi.nlm.nih.gov/25741868/)
